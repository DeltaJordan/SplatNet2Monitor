...
{
    public static class SplatNetApiClient
    {
        private static HttpClient httpClient;
        private static CookieContainer cookies;

        private static Cookie iksmCookie;
        ...
        private static void InitializeHttpClient()
        {
            ...
            httpClient.DefaultRequestHeaders.Add("Referer", "https://app.splatoon2.nintendo.net/home");
            ...
            httpClient.DefaultRequestHeaders.Add("x-unique-id", "15132846168746164214");
            httpClient.DefaultRequestHeaders.Add("x-timezone-offset", ((int)TimeZoneInfo.Local.BaseUtcOffset.TotalSeconds).ToString());
        }
        ...
        public static void ApplyIksmCookie(Cookie cookie)
        {
        ...
        public static async Task<string[]> RetrieveBattles(params int[] ignoredBattleNumbers)
        {
            if (iksmCookie == null)
            {
            ...
            JObject battleJson = await RetrieveBattleJson();
            ...
            foreach (JToken token in tokens)
            {
                ...
                splatoonBattles.Add((await RetrieveScoreboardJson(battleNumber)).ToString(Formatting.Indented));
            }

            return splatoonBattles.ToArray();
        }

        private static async Task<JObject> RetrieveScoreboardJson(int battleNumber)
        {
        ...
        private static async Task<JObject> RetrieveBattleJson()
        {
        ...
        public static async Task<SplatoonBattle> ParseBattle(string scoreboardJson)
        {
            ...
            return await ParseBattle(scoreboardJObject);
        }

        public static async Task<SplatoonBattle> ParseBattle(JObject scoreboardJson)
        {
            // Repeated variables.
